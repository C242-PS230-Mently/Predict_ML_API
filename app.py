...
def calculate_solusi(lv1, lv2, lv3, lv4, lv5):
    ...
    if total_level == 5:
        return {
            'Nama Solusi': 'Aktivitas Fisik Ringan dan Tidur Cukup',
        ...
        return {
            'Nama Solusi': 'Latihan Pernapasan dan Meditasi',
        ...
        return {
            'Nama Solusi': 'Yoga dan Olahraga Ringan',
        ...
        return {
            'Nama Solusi': 'Konsultasi dengan Terapis',
        ...
        return {
            'Nama Solusi': 'Terapi Perilaku Kognitif (CBT)',
        ...
        return {
            'Nama Solusi': 'Kegiatan Sosial dan Dukungan Keluarga',
        ...
        return {
            'Nama Solusi': 'Konsultasi Psikolog untuk Terapi Intensif',
        ...
        return {
            'Nama Solusi': 'Terapi Intensif dengan Psikiater',
        ...
        return {
            'Nama Solusi': 'Pengobatan Medis untuk Gangguan Mental',
        ...
        return {
            'Nama Solusi': 'Perawatan Intensif dan Terapi Rawat Inap',
        ...
        return {
            'Nama Solusi': 'Perawatan Medis Penuh dan Rawat Inap',
